...
struct VIBEHEIM_API FVHMSettings {
  ...
  // Blend factor for boundary stitching (0.0 = primary tile, 1.0 = adjacent
  // tile)
  UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Boundary")
  ...
  // Use prebaked heightfield data instead of runtime generation
  UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "VHM")
  bool bUsePrebakedHeightfield = false;
};
